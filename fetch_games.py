...
url = 'https://contribution.usercontent.google.com/download?c=CgthaWRhX2NvZGVmeBJ8Eh1hcHBfY29tcGFuaW9uX2dlbmVyYXRlZF9maWxlcxpbCiVodG1sX2RiZjRkNDFhMDNmNDRmMGNhZjc5MmFjODIyY2ZmNTE3EgsSBxCnvuPJ-gEYAZIBJAoKcHJvamVjdF9pZBIWQhQxNTA1OTg4MzUzNzY1OTY5MTM2Nw&filename=&opi=89354086'
...
"""
        with open('frontend/src/pages/GamesDiscoveryRetroEdition.jsx', 'w', encoding='utf-8') as out:
            out.write(comp_code)
        print('Created GamesDiscoveryRetroEdition.jsx')
