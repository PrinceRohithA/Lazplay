...
electron_1.contextBridge.exposeInMainWorld("lazplayAPI", {
    ...
    navigateStorePath: (path) => electron_1.ipcRenderer.invoke("navigate-store-path", path),
    ...
    getAccessToken: () => electron_1.ipcRenderer.invoke("get-access-token"),
    saveSession: (token, refreshToken) => electron_1.ipcRenderer.invoke("sync-session", { token, refreshToken }),
    ...
    uploadBuildDirectory: (params) => electron_1.ipcRenderer.invoke("upload-build-directory", params),
