...
export default function DeveloperWorkspace() {
  ...
  if (!user.roles.includes('DEVELOPER') && !user.roles.includes('ADMIN')) {
    return (
      <div className="max-w-container-max mx-auto p-gutter md:p-margin flex flex-col items-center justify-center min-h-[70vh] gap-8">
        <div className="text-center max-w-2xl">
          <h1 className="font-headline-lg text-headline-lg text-on-secondary-container uppercase mb-4 animate-pulse glow-primary-text">
            BECOME_A_CREATOR
          </h1>
          <p className="font-body-md text-on-surface-variant mb-8 leading-relaxed">
      ...
      <div className="grid grid-cols-12 gap-gutter">
        ...
        <div className="col-span-12 lg:col-span-8 bg-surface border-2 border-outline-variant hover:border-secondary-container transition-colors group relative overflow-hidden flex flex-col">
          ...
          <div className="p-4 flex-1 flex flex-col gap-4 relative">
            <div className="flex justify-between items-baseline">
              ...
              <span className="bg-surface-container border-2 border-secondary-container text-on-secondary-container font-label-mono text-label-mono px-2 py-1 flex items-center gap-1 shadow-[2px_2px_0_0_var(--secondary)]">
            ...
            <div className="flex-1 flex items-end gap-1 mt-4 h-32 w-full border-b-2 border-l-2 border-outline-variant pt-2 pr-2 relative">
              <div className="absolute inset-0 bg-[linear-gradient(rgba(var(--primary-rgb),0.1)_1px,transparent_1px)] bg-[length:100%_20px] pointer-events-none"></div>
              {(() => {
                ...
                return data.map((d, i) => {
                  ...
                  return (
                    <div 
                      key={d.date} 
                      className={`flex-1 group/bar relative border-t-2 transition-all ${isPeak ? 'bg-secondary-container border-secondary-fixed shadow-[0_0_10px_var(--secondary)]' : 'bg-surface-container border-outline-variant hover:bg-secondary-fixed-dim'}`}
                      style={{ height: `${height}%` }}
                    >
                      ...
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-surface-container-highest border border-outline-variant px-2 py-1 opacity-0 group-hover/bar:opacity-100 transition-opacity z-10 pointer-events-none whitespace-nowrap">
                        <span className="font-label-mono text-[9px] text-on-primary-container">
        ...
        <div className="col-span-12 lg:col-span-4 flex flex-col gap-gutter">
          <div className="bg-surface border-2 border-outline-variant p-4 hover:border-primary-container transition-all group flex-1 flex flex-col justify-center">
            ...
            <span className="font-headline-md text-headline-md text-on-surface mt-2 block group-hover:text-on-primary-container transition-colors">
