...
<span className="material-symbols-outlined text-primary-container cursor-pointer hover:text-primary-fixed transition-colors" data-icon="notifications">notifications</span>
<span className="material-symbols-outlined text-primary-container cursor-pointer hover:text-primary-fixed transition-colors" data-icon="account_circle">account_circle</span>
</div>
</div>
</header>
...
<img className="w-full h-full object-cover grayscale" data-alt="Cybernetic circuit board" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCPalAwPKqEL-Ly_Rh7yE6ozPaAKgX4VSCN5qTP3N5WXysaAaZg0K0lpuUQRUigkO6ANaq0WJBv1kEPmrRY2wMF_sieOyhC6J4qChCYMaVEp6Ifl9QAKoDWTNQirkdpkVB3O6_rJsagm_F8YdALa67osno1PNZQjgM8yiH2O3Nwh5CnqIgIA7dGvZTm9tAjpSMqDujHuHcMvZ-Nf25xc3eDsnkRMaq4fD6ZVNafuWz1PyaP4HOZDeiVkhJ6c2OcXUaQHZIS0nJ1S1oV"/>
</div>
...
<label className="font-label-caps text-[11px] text-on-surface-variant block uppercase tracking-wider">USER_ID</label>
...
<input className="bg-transparent border-none focus:ring-0 w-full text-primary-container font-mono uppercase py-3 placeholder:text-outline/50 placeholder:text-xs" placeholder="ENTER_IDENTIFIER" type="text"/>
<span className="w-1.5 h-5 bg-primary-container mr-3 cursor-blink"></span>
</div>
</div>
{/*  Access Key Field  */}
<div className="space-y-2">
<label className="font-label-caps text-[11px] text-on-surface-variant block uppercase tracking-wider">ACCESS_KEY</label>
<div className="relative flex items-center bg-surface-container-lowest border border-outline-variant focus-within:border-primary-container transition-all group">
<span className="pl-3 text-primary-container font-medium">&gt;</span>
<input className="bg-transparent border-none focus:ring-0 w-full text-primary-container font-mono tracking-[0.5em] py-3 placeholder:tracking-normal placeholder:text-outline/50 placeholder:text-xs" placeholder="••••••••" type="password"/>
</div>
</div>
{/*  Boot Sequence Button  */}
<button className="w-full bg-primary-container text-on-primary-container font-headline-md py-4 font-bold uppercase tracking-[0.2em] hover:bg-primary-fixed-dim active:scale-[0.98] transition-all neon-glow-primary relative overflow-hidden group mt-4" type="submit">
<span className="relative z-10">BOOT_SEQUENCE</span>
...
<p className="flex items-center gap-2"><span className="text-primary-container">[STATUS]</span> WAITING FOR USER INPUT_</p>
</div>
</div>
</main>
{/*  Footer  */}
