        ...
        <div className="bg-surface-container-low border-2 border-outline-variant p-3 md:p-4 pixel-border">
          <div className="flex flex-col gap-4">
            <div className="relative w-full">
              ...
              />
              <span className="absolute right-4 top-1/2 -translate-y-1/2 w-2 h-4 md:h-5 bg-primary-container animate-pulse"></span>
            </div>
            
            <div className="flex flex-wrap items-center gap-2 md:gap-3 border-t border-outline-variant pt-4">
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <label className="font-label-mono text-on-surface-variant text-[10px] uppercase shrink-0">SORT:</label>
                <select
                ...
                <div key={game.id} className="bg-surface-container border-2 border-outline-variant group hover:border-primary-container transition-all flex flex-col pixel-border relative overflow-hidden">
                  ...
                  <div className="p-4 flex-1 flex flex-col min-w-0">
                    <div className="flex justify-between items-start gap-2 mb-2">
                      ...
                      <span className={`font-label-mono text-[12px] md:text-[14px] shrink-0 ${priceColor(game)}`}>{priceLabel(game)}</span>
                    </div>
                    ...
                    <div className="mt-auto grid grid-cols-2 gap-2">
                      ...
                      <Link to={`/game?id=${game.id}`} className="border border-outline-variant text-on-surface-variant font-label-mono py-2 text-[11px] md:text-[12px] hover:bg-surface-bright transition-all uppercase text-center">DETAILS</Link>
                    </div>
                  </div>
                </div>
              ))}
